...
namespace ITech.Areas.Admin.Controllers
{
    ...
    {
        private readonly AdminGraficoVendasService _graficoVendas;

        public AdminGraficoController(AdminGraficoVendasService graficoVendas)
        {
        ...
        {
            var servicosVendasTotais = _graficoVendas.GetVendasServicos(dias);
